import{a as f,i as p,S as h}from"./assets/vendor-D0cagnvz.js";(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&t(l)}).observe(document,{childList:!0,subtree:!0});function c(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function t(e){if(e.ep)return;e.ep=!0;const s=c(e);fetch(e.href,s)}})();const b="47359796-f2fd064881319509e162de268",d=document.querySelector(".search-input"),v=document.querySelector(".search-button"),g=document.querySelector(".images"),m=document.querySelector(".loading-message"),n=document.querySelector(".loadmore-button");let i=1;const L=40;let r,u=0;async function y(){try{const a=(await f.get("https://pixabay.com/api/",{params:{key:b,q:d.value,image_type:"photo",per_page:L,page:i}})).data;if(u+=a.hits.length,a.hits.length===0&&i===1){p.error({message:"Sorry, there are no images matching your search query. Please try again!",position:"topRight"}),n.style.display="none";return}else u>=a.totalHits?(n.style.display="none",p.info({message:"We're sorry, but you've reached the end of search results.",position:"topRight"})):n.style.display="block";const c=a.hits.map(t=>`
        <li class="image">
